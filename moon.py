...
if __name__ == '__main__':
    ...
    net_locals = [copy.deepcopy(net_glob) for i in range(args.num_clients)]
    ...
    for iter in trange(args.global_ep):
        ...
        for idx in idxs_users:
            ...
            w = local.train(previous_net = copy.deepcopy(net_locals[idx]).to(args.device), global_net = copy.deepcopy(net_glob).to(args.device), net = copy.deepcopy(net_glob).to(args.device))
